...
layout: page
title: 데이터 과학
subtitle: 제19대 국회 본회의 출석부 - joyplot
output:
  html_document: 
    toc: yes
    keep_md: yes
...
parli_gs <- readRDS("data/parli_gs.rds")
```
...
``` {r party-joyplot-setup, eval=FALSE}
...
``` {r party-joyplot-wrangling, eval=FALSE}
