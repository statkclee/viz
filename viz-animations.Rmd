...
``` {r party-approval-static-facet, fig.width=12}
## 3.2. 정당별 지지율 시각화 ------------------------------------
ggplot(gallop_viz_df, aes(x=날짜, y=지지율, group=정당, color=정당)) +
  geom_point(size=1.5) +
  geom_line() +
...
``` {r party-approval-animation, eval=FALSE}
...
``` {r party-approval-animation-tweenr, eval=FALSE}
