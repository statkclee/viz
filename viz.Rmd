...
``` {r viz-motivation, warning=FALSE, message=FALSE}
# library(datasets)
# library(tidyverse)
# library(ggplot2)
# library(gridExtra)
...
``` {r viz-motivation-woman, warning=FALSE, message=FALSE}
...
``` {r viz-motivation-anscombe, warning=FALSE, message=FALSE}
data(anscombe)
datatable(anscombe) 
...
``` {r viz-base, warning=FALSE, message=FALSE}
#1. Base 시각화 시스템----------------------------------------------------------------
data(mtcars)
...
``` {r viz-lattice, warning=FALSE, message=FALSE}
#2. Lattice 시각화 시스템----------------------------------------------------------------
...
``` {r viz-grid, warning=FALSE, message=FALSE}
...
``` {r viz-datasaurus, warning=FALSE, message=FALSE}
# library(datasauRus)
datasaurus_dozen %>% 
    group_by(dataset) %>% 
    summarize(
