...
~~~{.output}
Error in mtcars %>% ggvis(~wt, ~mpg) %>% layer_points() %>% layer_smooths(): could not find function "%>%"
...
~~~{.output}
Error in mtcars %>% ggvis(~wt, ~mpg) %>% layer_lines(`:=`(stroke, "red"), : could not find function "%>%"
...
~~~{.output}
Error in mtcars %>% ggvis(~mpg) %>% layer_histograms(width = 7): could not find function "%>%"
...
~~~{.output}
Error in mtcars %>% ggvis(~mpg) %>% layer_densities(`:=`(fill, "orange")): could not find function "%>%"
...
~~~{.output}
Error in mtcars %>% ggvis(~factor(cyl)) %>% layer_bars(`:=`(fill, "orange")): could not find function "%>%"
...
~~~{.output}
Error in mtcars %>% ggvis(~mpg, ~wt, `:=`(fill, input_radiobuttons(label = "Choose color:", : could not find function "%>%"
...
~~~{.output}
Error in mtcars %>% ggvis(~mpg, ~wt, fill = input_select(label = "Choose fill variable:", : could not find function "%>%"
...
~~~{.output}
Error in mtcars %>% ggvis(~mpg, ~wt, `:=`(opacity, 0.6), fill = ~factor(cyl)) %>% : could not find function "%>%"
...
~~~{.output}
Error in add_axis("y", title = "연비(mpg"): could not find function "add_axis"
...
~~~{.output}
Error in mtcars %>% ggvis(~wt, ~mpg, fill = ~disp, stroke = ~disp, `:=`(strokeWidth, : could not find function "%>%"
